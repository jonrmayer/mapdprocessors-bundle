...
public final class Utils {
	 ...
	 *            an object reference
	 * @param varName
	 *            the variable name to use in an exception message if the check
	 *            fails
	...
	// fast version of SLF4J MessageFormat.format(), uses {} tokens, no escaping is
	// supported, no array content printing either.
	...
	private static DateFormat getISO8601DateFormat() {
		...
		// Stricter parsing to prevent dates such as 2011-12-50T01:00Z (December 50th)
		// from matching
	 ...
	 * readable format. It uses the bases 'KiB', 'MiB', and 'GiB' for 1024, 1024**2,
	 * and 1024**3.
	 * 
	 * @param number
	...
	public static String getSdcId() {
		...
		try {
			...
			throw new RuntimeException(
					Utils.format("SDC ID Callable threw an unexpected exception: {}", ex.toString(), ex));
		}
	}
}
